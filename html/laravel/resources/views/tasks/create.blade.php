        ...
        <form method="POST" action="{{ route('tasks.store', ['project' => $project->id]) }}">
            ...
            <div class="flex flex-col px-8 pt-6 mx-6 rounded-md bg-white">
                ...
                <div class="md:w-full mb-6">
                    ...
                    <x-textarea id="detail" class="block mt-1 w-full {{ $errors->has('detail') ? 'border-red-600' :'' }}" type="textarea" rows="10" name="detail" :value="old('detail')" placeholder="課題の詳細" maxlength='1000' autofocus />
                </div>
